	  	...
	  	<div class="row justify-content-end">
	  		...
	  		<div class="col-lg-9">
	  			<div class="hero-title">
	  				<a href="./single.html">
	  				<h1>Kim's Portfolio</h1> <h2>- Outcampus activities</h2>
	  				</a>
	  			</div>
...
<div class="row awp-team">
  ...
  <div class="col-xs-6 text-xs-center col-sm-6 text-sm-center col-md-4 text-md-center col-lg-3 text-lg-center">
      <a href="javascript:void(0);" onclick="$(&quot;#rdi-modal&quot;).modal();">
          <img class="img" src="images/동행.jpg">
          <p><strong>대학생연합동아리 '동행' </strong><br></p>
      </a>
  </div>
  ...
  <div class="col-xs-6 text-xs-center col-sm-6 text-sm-center col-md-4 text-md-center col-lg-3 text-lg-center">
      <a href="javascript:void(0);" onclick="$(&quot;#ost-modal&quot;).modal();">
          <img class="img" src="images/흥타령2.jpg"">
          <p><strong>흥타령예술단 </strong><br>2015-2019</p>
      </a>
  </div>
  ...
  <div class="col-xs-6 text-xs-center col-sm-6 text-sm-center col-md-4 text-md-center col-lg-3 text-lg-center">
      <a href="javascript:void(0);" onclick="$(&quot;#mfi-modal&quot;).modal();">
          <img class="img" src="images/어학.jpg">
          <p><strong>필리핀단기어학연수</strong><br>Fake title</p>
      </a>
  </div>
  ...
  <div class="col-xs-6 text-xs-center col-sm-6 text-sm-center col-md-4 text-md-center col-lg-3 text-lg-center">
      <a href="javascript:void(0);" onclick="$(&quot;#rku-modal&quot;).modal();">
          <img class="img" src="images/해외봉사.jpg">
          <p><strong>한중일 라오스해외봉사단</strong><br>Fake person with longer title</p>
      </a>
  </div>
  ...
  <div class="col-xs-6 text-xs-center col-sm-6 text-sm-center col-md-4 text-md-center col-lg-3 text-lg-center">
      <a href="javascript:void(0);" onclick="$(&quot;#phe-modal&quot;).modal();">
          <img class="img" src="images/워홀3.jpg">
          <p><strong>워킹홀리데이</strong><br>Fake title</p>
      </a>
  </div>
  ...
  <div class="col-xs-6 text-xs-center col-sm-6 text-sm-center col-md-4 text-md-center col-lg-3 text-lg-center">
      <a href="javascript:void(0);" onclick="$(&quot;#jja-modal&quot;).modal();">
          <img class="img" src="images/공모전.jpg">
          <p><strong>기후변화보드게임 공모전</strong><br>최우수 수상</p>
      </a>
  </div>
  ...
  <div class="col-xs-6 text-xs-center col-sm-6 text-sm-center col-md-4 text-md-center col-lg-3 text-lg-center">
      <a href="javascript:void(0);" onclick="$(&quot;#gla-modal&quot;).modal();">
          <img class="img" src="images/나비의꿈.jpg">
          <p><strong>교외 뮤지컬단원 </strong><br>'나비의 꿈'</p>
      </a>
  </div>
